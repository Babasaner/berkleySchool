			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						<li class="active"><a href="index.html" class="effect-3">Accueil</a></li>
						<li><a href="#about" class="effect-3 scroll">A propos de nous</a></li>
						<li><a href="#services" class="effect-3 scroll">Informations générale</a></li>
						<li><a href="#demande" class="effect-3 scroll">Demande d'inscription</a></li>
						<li><a href="#gallery" class="effect-3 scroll">Gallerie</a></li>
						<li><a href="#mail" class="effect-3 scroll">Contact</a></li>
					</ul>
				</nav>
	...
	<div class="col-md-6 w3l_about_bottom_right one" id="demande" >
		<div class="abt-w3l">
			<div class="header-w3l" >
				...
				<h4>Renseigner les champs ci-dessus</h4>
				<form action="#" method="post" class="d-flex align-items-center" >
					<div class="col-xl-6 col-xs-6 w3l-left-mk">
						<ul>
							<li class="text">Nom :  </li>
							...
							<li class="text">Nom complet parent/tuteur  :  </li>
							<li class="agileits-main"><i class="fa fa-user-o" aria-hidden="true"></i><input name="name" type="text" required=""></li>
							<li class="text">Sexe  :  </li>
					...
					<div class="col-md-6 col-xs-6 w3l-right-mk">
						<ul>
							<li class="text">NumTel  :  </li>
							<li class="agileits-main"><i class="fa fa-phone" aria-hidden="true"></i><input name="mobile" type="text" required=""></li>
							<li class="text">Addresse  :  </li>
							<li class="agileits-main"><i class="fa fa-home" aria-hidden="true"></i><input name="address" type="text" required=""></li>
							<li class="text">NumTel parent/tuteur  :  </li>
							<li class="agileits-main"><i class="fa fa-phone" aria-hidden="true"></i><input name="address" type="text" required=""></li>
							<li class="text">classe  :  </li>
...
<div class="services" id="services" >
	<div class="container">  
		<h3 class="w3l-title">Informations Générales</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
...
<section class="portfolio-w3ls" id="gallery">
		<h3 class="w3l-title">Notre Gallerie</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<?php 
...
<div class="team-w3l" >
	<div class="container">
		<h3 class="w3l-title">Nos partenaires</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/8c62d36d-169e-41cc-b300-3da3216265a4.JPG" alt="" whidth=600 height=420>
				  <h5>Abdoul</h5>
				  <div class="about_opa">
					<p>DevWeb back-end</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/6ff81fe2-dbf0-4c38-bb78-71b05c3e661e.JPG" alt="">
				  <h5>Dieylani</h5>
				  <div class="about_opa">
					<p>DevWeb front-end</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/1960e31a-23c1-41b0-a542-46b4ef7545d4.JPG" alt="">
				  <h5>Sané</h5>
				  <div class="about_opa">
					<p>Designer</p>
					<ul class="fb_icons2 text-center">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/6ff81fe2-dbf0-4c38-bb78-71b05c3e661e.JPG" alt="" height=420 width=600 >
				  <h5>Mbacke Fall</h5>
				  <div class="about_opa">
					<p>DevWeb</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/35b84345-c61e-4aa7-a471-69a55c8c21a5.JPG" alt="" height=420 width=600 >
				  <h5>Equipe full stack</h5>
				  <div class="about_opa">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/87f25987-bc2f-4c2d-a754-514c070d7bd8.JPG" alt="" height=420 width=600 >
				  <h5>Classe</h5>
				  <div class="about_opa">
					<p>Informaticien</p>
					<ul class="fb_icons2 text-center">
...
>>>>>>> 25fae06df74e65e5a6ed9bad4b25a4e57c1edf2f
		...
		<div class="w3l-form">
			<h3 class="w3l-title">Contacter nous directement</h3>
